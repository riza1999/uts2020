...
const routes = [
    ...
    {
        path: ':itemId',
        loadChildren: () => __webpack_require__.e(/*! import() | detail-detail-module */ "detail-detail-module").then(__webpack_require__.bind(null, /*! ./detail/detail.module */ "./src/app/home/detail/detail.module.ts")).then(m => m.DetailPageModule)
    }
];
...
HomePage.propDecorators = {
    listview: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['listview',] }],
    gridview: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['gridview',] }]
};
