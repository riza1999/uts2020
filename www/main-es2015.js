...
const routes = [
    ...
    {
        path: 'admin',
        loadChildren: () => Promise.all(/*! import() | admin-admin-module */[__webpack_require__.e("common"), __webpack_require__.e("admin-admin-module")]).then(__webpack_require__.bind(null, /*! ./admin/admin.module */ "./src/app/admin/admin.module.ts")).then(m => m.AdminPageModule)
    },
    {
        path: 'about',
...
module.exports = __webpack_require__(/*! /Users/subhanhasbiyudha/Kampus/Semester7/Crossplatform Mobile/uts2020/src/main.ts */"./src/main.ts");
